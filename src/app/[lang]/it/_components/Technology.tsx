...
export const Technology: FC<ITechnologyProps> = ({
	...
	return (
		...
		>
			...
			<div
				className={twMerge(
					"absolute z-[20] -top-[40px] left-1/2 -translate-x-1/2 scale-0 w-auto whitespace-nowrap bg-light text-black rounded-md text-center px-xs py-xxs transition-transform duration-300 ease",
					...
					isActive && "-translate-x-1/2 scale-100",
				)}
			>
				{name}
			</div>
