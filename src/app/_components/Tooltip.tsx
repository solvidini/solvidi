...
export const Tooltip: FC<ITooltipProps> = ({
	...
	return (
		...
		>
			...
			<div
				className={twMerge(
					"absolute z-[100] drop-shadow-md bottom-[calc(100%+8px)] left-1/2 -translate-x-1/2 scale-0 w-auto whitespace-nowrap bg-light text-black rounded-md text-center px-xs py-xxs transition-transform duration-200 ease",
