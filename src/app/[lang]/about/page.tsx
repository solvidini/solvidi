	...
	return (
		<main className="overflow-auto min-h-screen flex flex-col items-center fade-in gap-lg">
			...
			<article className="relative w-full max-w-con-min px-lg flex flex-col items-center justify-center gap-lg">
				<Image
					className="transition-all z-10 ease-in-out duration-300 hover:scale-105 hover:brightness-105 rounded-full border-l-[6px] border-primary hover:border-secondary"
					src="/solvidi.jpeg"
					alt="Solvidi"
					width={300}
					height={300}
