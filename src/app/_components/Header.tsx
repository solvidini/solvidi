...
export const Header: FC<IHeaderProps> = ({ children, className }) => (
	<div className={twMerge("relative inline-block", className)}>
		<IoMdMusicalNotes className="absolute z-10 -left-[8px] -top-[6px] h-[40px] w-[40px] -rotate-[18deg]" />
		<IoMdMusicalNote className="absolute z-10 right-0 -top-[4px] h-[40px] w-[40px] rotate-[16deg]" />
